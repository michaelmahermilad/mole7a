...
function BankCard() {
  return (
    ...
    <div className=' w-[90%] lg:w-[30%] m-auto   rounded-sm   bg-[white] shadow-xl   overflow-hidden    '>
        <p className='text-center  text-[15px]   text-white bg-[brown] px-3 py-3'> شارك معنا بالخدمة </p>
...
<p className='text-right font-bold   text-[13px]     '> <strong className='text-[brown]'>اسم البنك :</strong> بنك مصر</p>
<p className='text-right  font-bold text-[13px]     '> <strong className='text-[brown]'>سويفت كود : </strong>  ***********</p>
<p className='text-right  font-bold  text-[13px]    '> <strong className='text-[brown]'>رقم الحساب : </strong>  **************</p>
